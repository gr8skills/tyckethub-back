...
<body translate="no" data-new-gr-c-s-check-loaded="14.1014.0" data-gr-ext-installed="">
@for($i=1; $i<=$ticket_qty; $i++)
<div class="cardWrap">
    <div class="card cardLeft">
        <h1>Tickethub <span>Event</span><span style="font-size: xx-small; padding-left: 5px;">{{ $unique_id }}</span></h1>
        <div class="title">
            <h2>{{ $event_title }}</h2>
            <span>event</span>
        </div>
        ...
        <div class="time">
            <h2>{{ date("g:i a", strtotime($start_time)) }}</h2>
            <span>time</span>
        </div>
